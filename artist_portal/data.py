...
def get_ddstudies_data():
    ...
    studies_sheet = pd.read_csv('https://docs.google.com/spreadsheets/d/14xTqtuV3BuKDNhLotB_d1aFlBGnDJOY0BRXJ8-86GpA/export?format=csv&gid=0', skiprows = 3)

    studies_csv = studies_sheet.copy()
